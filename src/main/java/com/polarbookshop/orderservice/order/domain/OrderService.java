...
public class OrderService {
    ...
    /**
     * Consumes the order dispatched event and updates the order status to DISPATCHED.
     *
     * @param flux the stream of order dispatched events
    ...
    /**
     * Builds a new order with the status set to DISPATCHED.
     *
